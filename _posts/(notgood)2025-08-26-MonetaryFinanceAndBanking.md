...
<table border="1" width="100%">
  ...
  <tr>
    <td>1: Course Overview of Money and Banking</td>
    <td>
      <ul>
        <li>Introduction to the content of Money and Banking course</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>2: Introduction to Money and Financial System</td>
    <td>
      <ul>
        <li>Overview of money and financial system</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>3-7: Interest Rates</td>
    <td>
      <ul>
        <li>Definition of interest rates</li>
        <li>Time value of money and interest rates</li>
        <li>Interest rates in the interest rate market (Part 1 & Part 2)</li>
        <li>Money market, bond market and interest rate liberalization</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>8-10: Financial Markets</td>
    <td>
      <ul>
        <li>Stock market (Part 1 & Part 2)</li>
        <li>Derivatives market</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>11: Group Assignment Presentation</td>
    <td>
      <ul>
        <li>Group homework presentation and discussion</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>12-13: Financial Institutions & Commercial Banks</td>
    <td>
      <ul>
        <li>Financial institutions and commercial banks (Part 1 & Part 2)</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>14: Financial Experiments</td>
    <td>
      <ul>
        <li>Interest rate and inflation experiment</li>
        <li>Bank run experiment</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>15: Other Financial Institutions</td>
    <td>
      <ul>
        <li>Introduction to non-commercial bank financial institutions</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td>16-18: Central Bank & Money Supply</td>
    <td>
      <ul>
        <li>Overview of central bank</li>
        <li>Central bank and money supply</li>
      </ul>
    </td>
  </tr>
</table>
